...
async fn main() {
    ...
    let position_init = rotated_positions;
    print!(
        "joder: {}, {}, {}, {}\n",
        rotated_positions[0][0],
        rotated_positions[0][1],
        rotated_positions[0][2],
        rotated_positions[0][3]
    );
    print!(
        "joder: {}, {}, {}, {}\n",
        rotated_positions[1][0],
        rotated_positions[1][1],
        rotated_positions[1][2],
        rotated_positions[1][3]
    );
    loop {
        ...
        if angle != new_angle {
            ...
            print!("{}, {}\n", angle, new_angle);
            rotated_positions =
                rotate_positions(rotation_matrix, position_init, (screen_x, screen_y));
